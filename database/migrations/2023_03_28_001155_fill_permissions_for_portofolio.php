...
class FillPermissionsForPortofolio extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPortofolio constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.portofolio.create',
            'admin.portofolio.show',
            'admin.portofolio.edit',
            'admin.portofolio.delete',
            'admin.portofolio.bulk-delete',
        ]);
